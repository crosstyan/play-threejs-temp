...
function stringToAxes(axesString: string) {
...
function getBasisTransform(from: string, to: string, targetMatrix: Matrix4) {
...
function axesToAsciiImage(str:string) {
...
// https://github.com/gkjohnson/threejs-sandbox/tree/master/basis-transform
